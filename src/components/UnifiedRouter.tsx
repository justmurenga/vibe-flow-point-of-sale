...
console.log('🛣️ [ROUTER] UnifiedRouter module loading...');
console.log('🛣️ [ROUTER] React hooks available:', { useState: typeof useState, useEffect: typeof useEffect });
...
export function UnifiedRouter({ children }: UnifiedRouterProps) {
  ...
  try {
    ...
    console.error('❌ [ROUTER] Error in UnifiedRouter:', error);
    throw error;
  }
}
